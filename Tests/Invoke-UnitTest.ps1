...
Get-ChildItem -Path "..\Source\TridentCC.Common\Public" -Filter *.ps1 | ForEach-Object {
    . $_.FullName
}

Get-ChildItem -Path "..\Source\TridentCC.Common\Private" -Filter *.ps1 | ForEach-Object {
    . $_.FullName
}
